...
### 기능 A: 입찰 예정 공고 관리
- 공고 상세 모달에 '입찰예정' / '제외' 버튼 추가 (관리자만)
- 태그 테이블 생성 (공고 ID + 태그명)
  - 태그: '입찰대상', '제외', '검토중', '낙찰', '유찰' 등 상태 확장 가능
- '입찰 예정 공고 리스트': 입찰대상 태그 공고만 표시
- '제외된 공고 리스트': 제외 태그 공고 표시 + 복원 가능
- '공고 중인 사업리스트': 제외 태그 공고 숨김
- 입찰 진행 상태 관리 (입찰대상 → 준비중 → 제출완료 → 낙찰/유찰)
...
- [ ] 모달에 '입찰예정' / '제외' 버튼 (관리자만)
- [ ] 입찰 예정 공고 리스트 페이지
- [ ] 제외된 공고 리스트 페이지 (복원 기능)
- [ ] 공고 리스트에서 제외 공고 숨김
- [ ] 상태 관리 (입찰대상 → 준비중 → 제출완료 → 낙찰/유찰)
